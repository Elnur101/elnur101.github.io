...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
    <a class="navbar-brand" href="index.php">EBR</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="login">
            ...
            <button type="button" class="btn btn-primary"><i class="fa fa-download" aria-hidden="true">Download</i></button>
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="web/img/slide/1.jpg" class="d-block w-100" alt="...">
             ...
             <div class="col-lg-3 col-md-6 mb-4">
                 <div class="card">
                     ...
                     <div class="view overlay">
                         <img class="card-img-top" src="https://strongler.com.ua/image/cache/catalog/parser/2087/zu8rp40ugd-1000x1000.jpg" alt="Fila">
                         <a href="">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5>
                            <strong>
                                <a href="#" class="dark-grey-text">FILA t-shirt<span class="badge badge-pill danger-color">NEW</span></a>
                            </strong>
                        </h5>
